...
void display()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (ImGui::SliderFloat("Slider", &value, minVal, maxVal, "%.3f")) {
            // Action when the slider value changes
            cube.center.x = value;
        }

        // if (ImGui::Button("Move object to Left")) {
        //     cube.center.x += 0.01;
        //     // std::cout << cube.center.x << " " << cube.center.y << std::endl;
        // }
        //  if (ImGui::Button("Move object to Top")) {
        //     cube.center.y += 0.01;
        //     // std::cout << cube.center.x << " " << cube.center.y << std::endl;
        // }
        ImGui::End();
